    ...
    <div className="card-table-wrap">
      ...
      <dialog open={modalOpen}>
        <div className="dialog-wrap">
          ...
          <a onClick={() => setModalOpen(false)} className="dialog-close">
            <svg
              width="13"
              height="13"
              viewBox="0 0 13 13"
            ...
            >
              <path
                d="M1 1.00024C1.11851 1.35758 1.71467 2.19256 2.6125 3.15144C3.68599 4.29793 5.36345 5.3637 6.35376 6.02629C7.3278 6.67801 8.35861 7.70164 9.8526 9.10495C10.2153 9.43804 10.4523 9.61582 10.7226 9.85554C10.9928 10.0953 11.2891 10.3915 11.774 10.8764"
                stroke="black"
                strokeWidth="2"
                strokeLinecap="round"
              />
              <path
                d="M10.5156 1.00024C10.3971 1.35758 9.91949 2.07405 9.29101 2.79321C8.71087 3.45706 8.06637 4.22884 7.13711 5.1563C5.75394 6.5368 4.35295 8.35885 3.8735 9.07802C3.33481 9.73792 2.79611 10.0971 2.43788 10.3655C2.25741 10.5154 2.07964 10.6932 1.89648 11.0559"
                stroke="black"
                strokeWidth="2"
                strokeLinecap="round"
              />
